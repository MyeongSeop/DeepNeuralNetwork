...
class AlexNet(nn.Module):
    def __init__(self, input_channel, output_dim, learning_rate, reg_lambda, device):
        ...
        # =============================== EDIT HERE ===============================
        # convolution layers
        self.CONV1 = nn.Conv2d(in_channels=input_channel, out_channels=96, kernel_size=(11, 11), stride=4, padding=0)
        ...
        self.FC_layers = nn.Sequential(self.drop, self.FC1, nn.ReLU(), self.drop, self.FC2, nn.ReLU(), self.FC3)
